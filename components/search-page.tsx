...
export function SearchPage({ initialCards, initialTotal, sets, rarities }: SearchPageProps) {
  ...
  // Only fetch when search params change (not on initial mount)
  useEffect(() => {
    if (hasSearched || query || selectedSet !== 'all' || selectedRarity !== 'all' || cardNumber) {
      setHasSearched(true)
      searchCards()
    }
